...
<body class="bg-gray-50">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <div class="bg-indigo-800 text-white w-64 py-6 flex flex-col h-full fixed">
            <div class="px-6 mb-8">
            ...
            <nav class="flex-1">
                ...
                <a href="{{ route('supervisor.assignments.index') }}" class="flex items-center px-6 py-3 bg-indigo-900 transition-colors duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
