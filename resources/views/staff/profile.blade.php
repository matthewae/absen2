    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div id="sidebar" class="bg-black text-yellow-300 w-full md:w-64 py-6 flex flex-col fixed md:relative z-10 transform -translate-x-full md:translate-x-0 transition-transform duration-200 ease-in-out">
            ...
            <nav class="flex-1">
                ...
                <a href="{{ route('staff.profile') }}" class="flex items-center px-6 py-3 bg-yellow-600 text-black font-semibold">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                    Profile
                </a>
                <a href="{{ route('staff.settings') }}" class="flex items-center px-6 py-3 hover:bg-yellow-500 hover:text-black transition-colors duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 w-full p-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 md:p-6 border border-yellow-200">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="text-center">
                        ...
                        <form action="{{ route('staff.update-photo') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex items-center justify-center">
                                <label class="bg-yellow-600 text-black px-4 py-2 rounded-lg cursor-pointer hover:bg-yellow-700 transition-colors duration-200">
                    ...
                    <div class="bg-yellow-50 rounded-lg p-4 md:p-8 space-y-6 md:space-y-8 border border-yellow-200">
                        <div class="border-b border-yellow-200 pb-4 md:pb-6">
